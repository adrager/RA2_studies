...
*/
  ...
  TString prTree("LostLeptonPrediction");
  vector<TString> exFiles;
  TString exTree("LostLeptonPrediction");

  prFiles.push_back("/afs/desy.de/user/a/adraeger/lostlepton2macros/results/prediction.root");
//  prFiles.push_back("/afs/desy.de/user/a/adraeger/lostlepton2macros/results/expectation.root");
...
if (1)
{
        ...
        if (data)         c->Add("/afs/desy.de/user/a/adraeger/lostlepton2macros/results/data.root");
        else c->Add("/afs/desy.de/user/a/adraeger/lostlepton2macros/results/prediction.root");
        if (debug && data) std::cout<<"source file: /afs/desy.de/user/a/adraeger/lostlepton2macros/results/data.root"<<std::endl;
        if (debug && !data) std::cout<<"source file: /afs/desy.de/user/a/adraeger/lostlepton2macros/results/prediction.root"<<std::endl;
        ...
        c->SetBranchAddress("patMuonsPFIDIsoNum",&muPromtMatched);
        Int_t nElec=0;
        c->SetBranchAddress("patElectronsIDIsoNum",&nElec);

        Float_t resultBBBWMTWDiLep =0;        
        c->SetBranchAddress("totalWeightMTWDiLep",&resultBBBWMTWDiLep);
        Float_t muonBinByBinIsoWeight =0;
        c->SetBranchAddress("muIsoWeight",&muonBinByBinIsoWeight);        
        Float_t muonBinByBinRecoWeight =0;
        c->SetBranchAddress("muRecoWeight",&muonBinByBinRecoWeight);        
        Float_t muonBinByBinAccWeight =0;
        c->SetBranchAddress("muAccWeight",&muonBinByBinAccWeight);        
        Float_t elecBinByBinIsoWeight =0;
        c->SetBranchAddress("elecIsoWeight",&elecBinByBinIsoWeight);        
        Float_t elecBinByBinRecoWeight =0;
        c->SetBranchAddress("elecRecoWeight",&elecBinByBinRecoWeight);        
        Float_t elecBinByBinAccWeight =0;
        c->SetBranchAddress("elecAccWeight",&elecBinByBinAccWeight);        


// all uncertainties

        Float_t resultBBBWMTWUp =0;
        c->SetBranchAddress("totalWeightMTWUp",&resultBBBWMTWUp);
        Float_t resultBBBWMTWDown =0;
        c->SetBranchAddress("totalWeightMTWDown",&resultBBBWMTWDown);

        Float_t resultBBBWMTWDiLepUp =0;
        c->SetBranchAddress("totalWeightMTWDiLepUp",&resultBBBWMTWDiLepUp);
        Float_t resultBBBWMTWDiLepDown =0;
        c->SetBranchAddress("totalWeightMTWDiLepDown",&resultBBBWMTWDiLepDown);


        Float_t resultWeightBinByBinAccUp =0;
        c->SetBranchAddress("muAccUp",&resultWeightBinByBinAccUp);
        Float_t resultWeightBinByBinAccDown =0;
        c->SetBranchAddress("muAccDown",&resultWeightBinByBinAccDown);
        Float_t elecAccUp =0;
        c->SetBranchAddress("elecAccUp",&elecAccUp);
        Float_t elecAccDown =0;
        c->SetBranchAddress("elecAccDown",&elecAccDown);


        Float_t resultWeightBBBDiBoDown =0;
        c->SetBranchAddress("totalWeightMTWDiLepDiBosonDown",&resultWeightBBBDiBoDown);


        Float_t resultWeightBBBNoCloUp =0;
        c->SetBranchAddress("totalWeightMTWDiLepDiNonCloUp",&resultWeightBBBNoCloUp);
        Float_t resultWeightBBBNoCloDown =0;
        c->SetBranchAddress("totalWeightMTWDiLepDiNonCloDown",&resultWeightBBBNoCloDown);
...
if (1)
{
        ...
        c->Add("/afs/desy.de/user/a/adraeger/lostlepton2macros/results/prediction.root");
        ...
        UShort_t patMuonsPFIDIsoNum=0;
        c->SetBranchAddress("patMuonsPFIDIsoNum",&patMuonsPFIDIsoNum);
        ...
        for(int ii = 0; ii < c->GetEntries(); ++ii)
        {
                  c->GetEntry(ii);
                // do sth with ht...
                if (HT > 500 && MHT >200 && NJets> 2.5 && patMuonsPFIDIsoNum >0.4)
                {
...
cout        <<" &$\\pm$"<<aresultBBBWMTWDiLep[i]-aresultBBBWMTWDown[i]
        ...
        <<"}^{+"<<aresultWeightBBBDiBoDown[i]-aresultBBBWMTWDiLep[i]
        <<"} $ "
...
cout<<binmap[i+1][2]<<"\\ldots "<<binmap[i+1][3]<<"& "<<binmap[i+1][4]<<" \\ldots "<<binmap[i+1][5] <<" &"<<ResultWeightData[i]<<" &"<<sqrt(ResultWeightDataStat[i])/aresultBBBWMTWDiLep[i] *100
        ...
        <<"}^{+"<<(aresultWeightBBBDiBoDown[i]-aresultBBBWMTWDiLep[i])/aresultBBBWMTWDiLep[i] *100
        <<"} $ "
